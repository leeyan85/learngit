...
class ScmDailyServerUsage(models.Model):
    ...
    assignedserverinusecount = models.IntegerField(db_column='AssignedServerInUseCount', blank=True, null=True)  # Field name made lowercase.
    usedratio = models.FloatField(db_column='UsedRatio', blank=True, null=True)  # Field name made lowercase.
    assignedratio = models.FloatField(db_column='AssignedRatio', blank=True, null=True)  # Field name made lowercase.
