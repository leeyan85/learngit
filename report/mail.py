def send_mail(subject, attachment='',content='', smtp_server='smtp.letv.cn', sender='SEE@le.com', receiver=['SEE@le.com','leitao@le.com'], cc_receiver=[]):
...
if __name__=='__main__':
    ...
    sender=sys.argv[3]
    receiver=sys.argv[4]
    send_mail(subject=subject, sender=sender,content=content,receiver=[receiver])
