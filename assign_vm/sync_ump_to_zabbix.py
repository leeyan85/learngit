...
def modify_zabbix_info_according_ip(ip,notes):
    try:
       ...
       if interface_items == 0:
           ...
           host_inventory.contact='see@le.com'
           host_inventory.save()
           return hostid
...
if __name__=="__main__":
    ...
    retired_idc=[u'中国_北京_北京_海淀_电信通_苏州桥_10_-1_C',u'中国_北京_北京_海淀_电信通_苏州桥_10_1_B01',u'中国_北京_北京_朝阳_电信通_惠普_112_2_4',u'中国_北京_北京_大兴_电信通_亦庄_东配楼_1_X',u'中国_北京_北京_大兴_电信通_亦庄_主楼_1_MD06',u'中国_广东_广州_南沙_天地祥云_平谦_C_2_204'] #已经不用的机房
    ...
    for server in result['data']:
        ...
        for ip_data in server['ip_data']:
            if internal_net.search(ip_data['ipaddr']):
                ...
                modify_zabbix_info_according_ip(ip_data['ipaddr'],tree)
