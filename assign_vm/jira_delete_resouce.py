...
jira=JIRA(basic_auth=("yangaofeng","ygf.1216"), server="http://jira.letv.cn/")
...
def delete_jira_resource(ip):
    resources=jira.search_issues("project in (SEEVM, SEERESOURCE) AND status = TBAssigned AND VMIP ~ %s"%ip,maxResults=50)
